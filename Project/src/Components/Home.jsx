      ...
      <div className="row">
        <div className="col-lg-4">
          <div className="left-image">
            ...
            <a href="property-details.html"><img src="/src/assets/images/featured-icon.png" alt style={{maxWidth: 60, padding: 0}} /></a>
          </div>
        </div>
                ...
                <div className="tab-pane fade show active" id="appartment" role="tabpanel" aria-labelledby="appartment-tab">
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <img src="/src/assets/images/deal-01.jpg" alt />
                    </div>
                    <div className="col-lg-3">
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <img src="/src/assets/images/property-01.jpg" alt />
        ...
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <img src="/src/assets/images/property-02.jpg" alt />
            <span className="category">Luxury Villa</span>
            <h6>$1.180.000</h6>
            <h4>54 Mid Street Florida, OR 27001</h4>
            <ul>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <img src="/src/assets/images/property-03.jpg" alt />
            <span className="category">Luxury Villa</span>
            <h6>$1.460.000</h6>
            <h4>26 Old Street Miami, OR 38540</h4>
            <ul>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <img src="/src/assets/images/property-04.jpg" alt />
            <span className="category">Apartment</span>
            <h6>$584.500</h6>
            <h4>12 New Street Miami, OR 12650</h4>
            <ul>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <img src="/src/assets/images/property-05.jpg" alt />
            <span className="category">Penthouse</span>
            <h6>$925.600</h6>
            <h4>34 Beach Street Miami, OR 42680</h4>
            <ul>
              <li>Bedrooms: <span>4</span></li>
              <li>Bathrooms: <span>4</span></li>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="item">
            <img src="/src/assets/images/property-06.jpg" alt />
            <span className="category">Modern Condo</span>
            <h6>$450.000</h6>
            <h4>22 New Street Portland, OR 16540</h4>
            <ul>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="item phone">
                <img src="/src/assets/images/phone-icon.png" alt style={{maxWidth: 52}} />
                <h6>010-020-0340<br /><span>Phone Number</span></h6>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="item email">
                <img src="/src/assets/images/email-icon.png" alt style={{maxWidth: 52}} />
